...
local function AtriumLootFn(lootdropper)
    lootdropper:SetLoot(nil)
        ...
        lootdropper:AddChanceLoot("nightmarefuel", .5)
        lootdropper:AddChanceLoot("armorskeleton_blueprint", .5)
        lootdropper:AddChanceLoot("skeletonhat_blueprint", .5)
        lootdropper:AddChanceLoot("thurible_blueprint", .5)
        ...
        lootdropper:AddChanceLoot("goldnugget", 1)
        lootdropper:AddChanceLoot("goldnugget", 1)
        lootdropper:AddChanceLoot("goldnugget", .5)
        lootdropper:AddChanceLoot("goldnugget", .5)
...
local function cave_fn()
    ...
    inst.components.lootdropper:AddChanceLoot("goldnugget", 1)
    inst.components.lootdropper:AddChanceLoot("goldnugget", .5)
    inst.components.lootdropper:AddChanceLoot("goldnugget", .5)
